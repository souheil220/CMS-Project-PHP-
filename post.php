            ...
            <div class="well">
                ...
                <form action="" method="POST" role="form">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="comment_author"></input>
                    </div>
                    <div class="form-group">
                        <label for="Email">Email</label>
                        <input class="form-control" name="comment_email"></input>
                    </div>
                    <div class="form-group">
                        <label for="Comment">Comment</label>
                        <textarea class="form-control" rows="3" name="comment_content"></textarea>
                    </div>
                    <button type="submit" name="crate_comment" class="btn btn-primary">Submit</button>
                </form>
            </div>
